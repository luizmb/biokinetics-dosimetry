...
public extension SeedDocuments {
    static func toxicologyModels(idFor: @Sendable (String) -> UUID) -> [ModelDocument] {
        [leadRabinowitz(idFor: idFor), methylmercury(idFor: idFor), cadmium(idFor: idFor)]
    }
}

// MARK: - Lead — Rabinowitz 3-Pool Model (Rabinowitz et al. Science 1976)

private func leadRabinowitz(idFor: @Sendable (String) -> UUID) -> ModelDocument {
...
private func methylmercury(idFor: @Sendable (String) -> UUID) -> ModelDocument {
...
private func cadmium(idFor: @Sendable (String) -> UUID) -> ModelDocument {
